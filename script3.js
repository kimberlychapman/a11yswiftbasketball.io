...
//       document.querySelector('img').src="img/zone.jpg";
    //   document.getElementById('defense-img').src="img/zone.jpg";
//       document.getElementById('d-type').innerHTML="Zone";
//   }

//   function changeDefenseBack(){
//     document.querySelector('img').src="img/m2m.jpg";
//     document.getElementById('d-type').innerHTML="Person-to-Person";
// }
...
function showCode2(){
    document.getElementById('white2').innerHTML="yourSkills == theirSkills || strongShooter";
    document.getElementById('hidden2').style.color="#eee";
}

function hideCode2(){
    document.getElementById('white2').innerHTML="(condition1) || (condition2)";
    document.getElementById('hidden2').style.color="transparent";
}

function showCode3(){
  document.getElementById('white3').innerHTML="! strongShooter  || ! strongDefender";
  document.getElementById('hidden3').style.color="#eee";
}

function hideCode3(){
  document.getElementById('white3').innerHTML="(condition1) || (condition2)";
...
//   ////////////////////////////
//   document.querySelector('.ih-item.square.colored.effect13.top_to_bottom ').style.display="none;"
//   ////////////////////////////
